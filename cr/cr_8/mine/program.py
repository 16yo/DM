...
if True:
    ...
    update_graph_button = pygame.Rect((0.1*buttons_edges[1].x+buttons_edges[0].x, 0.1*buttons_edges[1].y+buttons_edges[0].y, \
                                       0.35*buttons_edges[1].x, 0.3*buttons_edges[1].y))


    clear_graph_button = pygame.Rect((0.55*buttons_edges[1].x+buttons_edges[0].x, 0.1*buttons_edges[1].y+buttons_edges[0].y, \
                                       0.35*buttons_edges[1].x, 0.3*buttons_edges[1].y))

    eulers_way_button = pygame.Rect((0.05*alg_edges[1].x+alg_edges[0].x, 0.1*alg_edges[1].y+alg_edges[0].y, \
                                       0.1875*alg_edges[1].x, 0.3*alg_edges[1].y))
    show_eulers_way = False
    eulers_cycle_button = pygame.Rect((0.2875*alg_edges[1].x+alg_edges[0].x, 0.1*alg_edges[1].y+alg_edges[0].y, \
                                       0.1875*alg_edges[1].x, 0.3*alg_edges[1].y))
    show_eulers_cycle = False
    gamils_way_button = pygame.Rect((0.525*alg_edges[1].x+alg_edges[0].x, 0.1*alg_edges[1].y+alg_edges[0].y, \
                                       0.1875*alg_edges[1].x, 0.3*alg_edges[1].y))
    show_gamils_way = False
    gamils_cycle_button = pygame.Rect((0.7625*alg_edges[1].x+alg_edges[0].x, 0.1*alg_edges[1].y+alg_edges[0].y, \
                                       0.1875*alg_edges[1].x, 0.3*alg_edges[1].y))
...
# Text
if True:
    edges_input_box_header = font.render('Вершины и ребра:', True, (0, 0, 0))
    update_graph_button_text = button_font.render('Обновить граф', True, (0, 0, 0))
    clear_graph_button_text = button_font.render('Очистить граф', True, (0, 0, 0))

    eulers_way_button_text = button_font.render('Эйлеровый путь', True, (0, 0, 0))
    eulers_cycle_button_text = button_font.render('Эйлеровый цикл', True, (0, 0, 0))

    gamils_way_button_text = button_font.render('Гамильтоновый путь', True, (0, 0, 0))
    gamils_cycle_button_text = button_font.render('Гамильтоновый цикл', True, (0, 0, 0))

# Warnings
if True:
    show_warning = 0

    wrong_edges_input_warning = font.render('Неверные вводные данные!', True, (255, 0, 0))

    no_eulers_way_warning = font.render('В этом графе нет эйлеровых путей', True, (0, 0, 0))
    no_eulers_cycle_warning = font.render('В этом графе нет эйлеровых циклов', True, (0, 0, 0))

    no_gamils_way_warning = font.render('Данный граф не удовлетворяет условию Теоремы Дирака', True, (0, 0, 0))
    no_gamils_cycle_warning = font.render('Данный граф не удовлетворяет условию Теоремы Дирака', True, (0, 0, 0))

    wait_warning = font.render('Пожалуйста, подождите, пока обход завершиться', True, (0, 0, 0))
...
while running:
            ...
            if eulers_way_button.collidepoint(event.pos):
                if algo_active:
                    ...
                    if len(eulers_way) == 0:
                        ...
                        chain = font.render('Путь: ' + str(eulers_way), True, (0, 0, 0))
                        print(eulers_way)
            if eulers_cycle_button.collidepoint(event.pos):
                if algo_active:
                    ...
                    if len(eulers_cycle) == 0:
                        ...
                        chain = font.render('Цикл: ' + str(eulers_cycle), True, (0, 0, 0))
                        print(eulers_cycle)
            if gamils_way_button.collidepoint(event.pos):
                if algo_active:
                    ...
                    if len(gamils_way) == 0:
                        ...
                        chain = font.render('Путь: ' + str(gamils_way), True, (0, 0, 0))
                        print(gamils_way)
            if gamils_cycle_button.collidepoint(event.pos):
                if algo_active:
                    ...
                    if len(gamils_cycle) == 0:
                        ...
                        chain = font.render('Цикл: ' + str(gamils_cycle), True, (0, 0, 0))
                        print(gamils_cycle)
    ...
    if True:
        ...
        screen.blit(update_graph_button_text, (update_graph_button.x+8, update_graph_button.y+22))
        ...
        screen.blit(eulers_way_button_text, (eulers_way_button.x+18, eulers_way_button.y+22))
        pygame.draw.rect(screen, color_active if alg_box_active else color_inactive, eulers_cycle_button, 2)
        screen.blit(eulers_cycle_button_text, (eulers_cycle_button.x+16, eulers_cycle_button.y+22))

        pygame.draw.rect(screen, color_active if alg_box_active else color_inactive, gamils_way_button, 2)
        screen.blit(gamils_way_button_text, (gamils_way_button.x+5, gamils_way_button.y+22))
        pygame.draw.rect(screen, color_active if alg_box_active else color_inactive, gamils_cycle_button, 2)
        screen.blit(gamils_cycle_button_text, (gamils_cycle_button.x+3, gamils_cycle_button.y+22))
    ...
    if show_warning == 1:
        ...
        screen.blit(no_gamils_way_warning, (graph_edges[0].x + graph_edges[1].x * 0.02, \
                                                graph_edges[0].y + graph_edges[1].y * 0.8))
    elif show_warning == 5:
        screen.blit(no_gamils_cycle_warning, (graph_edges[0].x + graph_edges[1].x * 0.02, \
                                                graph_edges[0].y + graph_edges[1].y * 0.8))
    elif show_warning == 6:
        screen.blit(wait_warning, (graph_edges[0].x + graph_edges[1].x * 0.05, \
                                                graph_edges[0].y + graph_edges[1].y * 0.8))
